...
$sql = "SELECT * from admins where username='admin1' ";
...
?>
 ...
 <body>
       ...
       <button  class="dropdown-btn" ><i class="fa fa-edit" style="font-size:20px;color:brown;float:left"></i>Order
             ...
             <a  href="#skill"><i class="fa fa-map-marker" style="font-size:20px;color:brown;float:left;padding-left:2%;"></i>Track order</a>
         ...
         <div id="mainblock" >
         <form id="fo" action="aeditdetails.php" method="POST" onsubmit="fn()" >
